...
# -*- coding: utf-8 -*-
#
# rtfd-css documentation build configuration file, created by
# sphinx-quickstart on Thu Jul 14 19:17:34 2016.
#
...
latex_documents = [
    (master_doc, 'rtfd-css.tex', 'rtfd-css Documentation',
     'Ruslan Baratov', 'manual'),
]
...
man_pages = [
    (master_doc, 'rtfd-css', 'rtfd-css Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rtfd-css', 'rtfd-css Documentation',
     author, 'rtfd-css', 'One line description of project.',
     'Miscellaneous'),
]
