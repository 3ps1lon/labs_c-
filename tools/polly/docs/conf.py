...
# sphinx-quickstart on Mon Jul 25 21:47:33 2016.
#
...
project = 'Polly'
copyright = '2013-2016, Ruslan Baratov'
...
exclude_patterns = ['_build', '_venv', 'rtfd-css', 'examples/docs.rst']
...
latex_documents = [
    (master_doc, 'Polly.tex', 'Polly Documentation',
...
man_pages = [
    (master_doc, 'polly', 'Polly Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Polly', 'Polly Documentation',
     author, 'Polly', 'One line description of project.',
     'Miscellaneous'),
]
